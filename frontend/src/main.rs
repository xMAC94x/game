...
const QUAD: [Vertex; 18] = [
    Vertex { a_Pos: [ -QUAD_SIZE,  QUAD_SIZE,  QUAD_SIZE ], a_Col: [0.7 ,0.3, 0.3], a_Uv: [0.0, 1.0] },
    Vertex { a_Pos: [  QUAD_SIZE,  QUAD_SIZE,  QUAD_SIZE ], a_Col: [0.7 ,0.3, 0.3], a_Uv: [1.0, 1.0] },
    Vertex { a_Pos: [  QUAD_SIZE, -QUAD_SIZE,  QUAD_SIZE ], a_Col: [0.7 ,0.3, 0.3], a_Uv: [1.0, 0.0] },
    Vertex { a_Pos: [ -QUAD_SIZE,  QUAD_SIZE,  QUAD_SIZE ], a_Col: [0.7 ,0.3, 0.3], a_Uv: [0.0, 1.0] },
    Vertex { a_Pos: [  QUAD_SIZE, -QUAD_SIZE,  QUAD_SIZE ], a_Col: [0.7 ,0.3, 0.3], a_Uv: [1.0, 0.0] },
    Vertex { a_Pos: [ -QUAD_SIZE, -QUAD_SIZE,  QUAD_SIZE ], a_Col: [0.7 ,0.3, 0.3], a_Uv: [0.0, 0.0] },

    Vertex { a_Pos: [ -QUAD_SIZE, -QUAD_SIZE,  QUAD_SIZE ], a_Col: [0.3 ,0.7, 0.3], a_Uv: [0.0, 1.0] },
    Vertex { a_Pos: [  QUAD_SIZE, -QUAD_SIZE,  QUAD_SIZE ], a_Col: [0.3 ,0.7, 0.3], a_Uv: [1.0, 1.0] },
    Vertex { a_Pos: [  QUAD_SIZE, -QUAD_SIZE, -QUAD_SIZE ], a_Col: [0.3 ,0.7, 0.3], a_Uv: [1.0, 0.0] },
    Vertex { a_Pos: [ -QUAD_SIZE, -QUAD_SIZE,  QUAD_SIZE ], a_Col: [0.3 ,0.7, 0.3], a_Uv: [0.0, 1.0] },
    Vertex { a_Pos: [  QUAD_SIZE, -QUAD_SIZE, -QUAD_SIZE ], a_Col: [0.3 ,0.7, 0.3], a_Uv: [1.0, 0.0] },
    Vertex { a_Pos: [ -QUAD_SIZE, -QUAD_SIZE, -QUAD_SIZE ], a_Col: [0.3 ,0.7, 0.3], a_Uv: [0.0, 0.0] },

    Vertex { a_Pos: [ -QUAD_SIZE,  QUAD_SIZE, -QUAD_SIZE ], a_Col: [0.3 ,0.3, 0.7], a_Uv: [0.0, 1.0] },
    Vertex { a_Pos: [ -QUAD_SIZE,  QUAD_SIZE,  QUAD_SIZE ], a_Col: [0.3 ,0.3, 0.7], a_Uv: [1.0, 1.0] },
    Vertex { a_Pos: [ -QUAD_SIZE, -QUAD_SIZE,  QUAD_SIZE ], a_Col: [0.3 ,0.3, 0.7], a_Uv: [1.0, 0.0] },
    Vertex { a_Pos: [ -QUAD_SIZE,  QUAD_SIZE, -QUAD_SIZE ], a_Col: [0.3 ,0.3, 0.7], a_Uv: [0.0, 1.0] },
    Vertex { a_Pos: [ -QUAD_SIZE, -QUAD_SIZE,  QUAD_SIZE ], a_Col: [0.3 ,0.3, 0.7], a_Uv: [1.0, 0.0] },
    Vertex { a_Pos: [ -QUAD_SIZE, -QUAD_SIZE, -QUAD_SIZE ], a_Col: [0.3 ,0.3, 0.7], a_Uv: [0.0, 0.0] },
/*
    Vertex { a_Pos: [ -QUAD_SIZE,  QUAD_SIZE,  -QUAD_SIZE ], a_Col: [0.7 ,0.3, 0.3], a_Uv: [0.0, 1.0] },
    Vertex { a_Pos: [  QUAD_SIZE,  QUAD_SIZE,  -QUAD_SIZE ], a_Col: [0.7 ,0.3, 0.3], a_Uv: [1.0, 1.0] },
    Vertex { a_Pos: [  QUAD_SIZE, -QUAD_SIZE,  -QUAD_SIZE ], a_Col: [0.7 ,0.3, 0.3], a_Uv: [1.0, 0.0] },
